...
const reportError = require('./AkiraaBot/hidden')
const autobackup = require('./AkiraaBot/autobackup')
        ...
        try {
            ...
            try {
                ...
                if (user) {
                    ...
                    if(!('premium' in user)) user.moderator = false
            ...
            if (!m.fromMe && !global.owner && opts['self']) return await conn.reply(m.chat, '*❎.Bot seadang dalam mode self, hanya owner yang dpsr menggunakan bot*', m)
            if (opts['pconly'] && m.chat.endsWith('g.us')) return
            if (opts['gconly'] && !m.fromMe && !m.chat.endsWith('g.us')) return await conn.sendMessage(m.chat, { text: "*Maaf kak*\nSALShop Bot Tidak Bisa Digunakan digunakan di private chat\n\n_Hanya Bisa Digunakan Di Dalam Group_\n\nUpgrade Ke premium atau Join Grup Official salsa Bot untuk mendapatkan akses di privat chat\n\nhttps://chat.whatsapp.com/EQYFytR6uBH0Lp6Xs2Kpgr",   contextInfo: { externalAdReply: { showAdAttribution: true, title: "GROUP ONLY MODE",  body: wm,   thumbnailUrl: "https://telegra.ph/file/6c7e67ae027b1305c965c.png", sourceUrl: sgc, mediaType: 1,   renderLargerThumbnail: true }}}, { quoted: m})
...
global.dfail = (type, m, conn) => {
    ...
    let Syaiithumb = 'https://i3.wp.com/tmpfiles.org/dl/2379229/tmp.jpg'
    let Syaiithumb2 = 'https://i3.wp.com/tmpfiles.org/dl/2379136/tmp.jpg'
    let msg = {
...
title: namebot,
body: wm,
thumbnailUrl: Syaiithumb,
sourceUrl: sig,
mediaType: 1,
renderLargerThumbnail: true
}}}, { quoted: fkontak})
    let msgg = {
        unreg: `*🍀 ᴀɴᴅᴀ ʙᴇʟᴜᴍ ᴛᴇʀᴅᴀꜰᴛᴀʀ!*\n*ꜱɪʟᴀʜᴋᴀɴ ᴋᴇᴛɪᴋ @ᴠᴇʀɪꜰy  ᴀᴛᴀᴜ ʀᴇɢɪꜱᴛᴇʀ ʙɪꜱᴀ ᴊᴜɢᴀ ᴠᴇʀɪꜰɪᴋᴀꜱɪ ʟᴇᴡᴀᴛ ᴇᴍᴀɪʟ ᴜɴᴛᴜᴋ ᴍᴇɴᴅᴀꜰᴛᴀʀ.*
